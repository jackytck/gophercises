...
// Seed populates the initial data.
...
// AllPhones returns all the phones in db.
...
// FindPhone find a single phone by number.
...
// UpdatePhone updates a phone record.
...
// Migrate creates the phone_numbers table.
